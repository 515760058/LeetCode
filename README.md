...
- leetcode1150. 检查一个数是否在数组中占绝大多数
- leetcode1060 有序数组中的缺失元素
- leetcode274 H指数
- leetcode275 H指数II
- 剑指 Offer53-II 0～n-1中缺失的数字
- leetcode74 搜索二维矩阵  (面试题10.09. 排序矩阵查找)

// 二分 查找最接近的值
- leetcode1182 与目标颜色间的最短距离
...
- leetcode668 乘法表中第k小的数

- 面试题 10.05 稀疏数组搜索

- leetcode 1631 最小体力消耗路径
- leetcode 1292 元素和小于等于阈值的正方形的最大边长 (二维前缀和+二分)
...
- 面试题 16.11. 跳水板  简单 数组
- leetcode933 最近的请求次数  双端数组
- leetcode621. 任务调度器
- leetcode622. 设计循环队列
- leetcode641. 设计循环双端队列
- leetcode846. 一手顺子   map
- leetcode350 两个数组的交集II  map
- leetcode406. 根据身高重建队列      排序+重建
...
- leetcode554 砖墙
- leetcode 1292 元素和小于等于阈值的正方形的最大边长 （二维的前缀和+二分）
- leetcode 1590 使数组和能被P整除(前缀和+数学同余)
